...
import { sendOrderNotification } from "../utils/emailNotifier";  
...
// GET /api/orders/:id
export default getOrderById = async (req, res) => {
  try {
...
export default updateOrderStatus = async (req, res) => {
  try {
...
export default getMyOrders = async (req, res) => {
  try {
